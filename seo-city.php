...
<section id="bi-breadcrumbs" class="bi-bredcrumbs-section position-relative about-bgimgsize" data-background="/assets/img/bg/bread-bg.jpg">
    ...
    <div class="container">
        <div class="bi-breadcrumbs-content headline ul-li text-center">
            <h2 style="color: white"><b>SEO Services in <?php echo $fullCityName; ?></b></h2><br>
            <ul>
                <li><a href="/">Home</a></li>
                ...
                <div class="col-lg-8">
                    <div class="bi-service-details-text-area">
                        ...
                        <div class="bi-service-details-text headline pera-content">
                            ...
                            <p>Partner with us, and let's unlock the full potential of your online presence in <?php echo $fullCityName; ?>. Dominate search engine results, attract your target audience, and watch your business thrive in the digital realm. Invest in SEO with Thiyagidigital—where visibility transforms into profitability.</p>
