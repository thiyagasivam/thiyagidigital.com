...
if ($_POST) {
    try {
        ...
        echo "<script>alert('Sorry, there was an error sending your message. Please try again or contact us directly at info@thiyagidigital.com'); window.history.back();</script>";
    }
} else {
    // No POST data
