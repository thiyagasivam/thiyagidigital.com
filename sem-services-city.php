...
$supportedCities = [
    ...
    'stuttgart' => ['name' => 'Stuttgart', 'state' => 'Baden-W�rttemberg'],
    ...
    // Europe - France
    'paris' => ['name' => 'Paris', 'state' => '�le-de-France'],
    'marseille' => ['name' => 'Marseille', 'state' => 'Provence-Alpes-C�te d\'Azur'],
    'lyon' => ['name' => 'Lyon', 'state' => 'Auvergne-Rh�ne-Alpes'],
    'toulouse' => ['name' => 'Toulouse', 'state' => 'Occitanie'],
    'nice' => ['name' => 'Nice', 'state' => 'Provence-Alpes-C�te d\'Azur'],
    ...
    'gothenburg' => ['name' => 'Gothenburg', 'state' => 'V�stra G�taland County'],
    'malmo' => ['name' => 'Malmo', 'state' => 'Sk�ne County'],
    'uppsala' => ['name' => 'Uppsala', 'state' => 'Uppsala County'],
    'vasteras' => ['name' => 'Vasteras', 'state' => 'V�stmanland County'],
    'orebro' => ['name' => 'Orebro', 'state' => '�rebro County'],
    'linkoping' => ['name' => 'Linkoping', 'state' => '�sterg�tland County'],
    'helsingborg' => ['name' => 'Helsingborg', 'state' => 'Sk�ne County'],
    'jonkoping' => ['name' => 'Jonkoping', 'state' => 'J�nk�ping County'],
    'norrkoping' => ['name' => 'Norrkoping', 'state' => '�sterg�tland County'],
    ...
    'lodz' => ['name' => 'Lodz', 'state' => 'L�dz Voivodeship'],
    ...
    'monterrey' => ['name' => 'Monterrey', 'state' => 'Nuevo Le�n'],
    'puebla' => ['name' => 'Puebla', 'state' => 'Puebla'],
    'tijuana' => ['name' => 'Tijuana', 'state' => 'Baja California'],
    'leon' => ['name' => 'Le�n', 'state' => 'Guanajuato'],
    'juarez' => ['name' => 'Ju�rez', 'state' => 'Chihuahua'],
    'torreon' => ['name' => 'Torre�n', 'state' => 'Coahuila'],
    'queretaro' => ['name' => 'Quer�taro', 'state' => 'Quer�taro'],
    'merida' => ['name' => 'M�rida', 'state' => 'Yucat�n']
];
