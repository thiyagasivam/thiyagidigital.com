...
<section id="bi-breadcrumbs" class="bi-bredcrumbs-section position-relative about-bgimgsize" data-background="/assets/img/bg/bread-bg.jpg">
    ...
    <div class="container">
        <div class="bi-breadcrumbs-content headline ul-li text-center">
            <h1 style="color: white"><b>Best Social Media Marketing Services in <?php echo $fullCityName; ?></b></h1><br>
            <ul>
                <li><a href="/">Home</a></li>
                                        ...
                                        <div class="accordion" id="accordionSidebarSMM">
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="smmfaq2c" class="accordion-collapse collapse" aria-labelledby="smmfaq2" data-bs-parent="#accordionSidebarSMM">
                                                    <div class="accordion-body">
                                                        It depends on your nicheâ€”Facebook, Instagram, LinkedIn, and YouTube are common choices in <?php echo $fullCityName; ?>.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
