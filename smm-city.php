...
$newCities = [
    ...
    // Middle East Cities - Qatar
    'doha' => ['name' => 'Doha', 'state' => 'Qatar'],
    'west-bay' => ['name' => 'West Bay', 'state' => 'Qatar'],
    'msheireb' => ['name' => 'Msheireb', 'state' => 'Qatar'],
    'al-sadd' => ['name' => 'Al Sadd', 'state' => 'Qatar'],
    'al-dafna' => ['name' => 'Al Dafna', 'state' => 'Qatar'],
    'al-gharrafa' => ['name' => 'Al Gharrafa', 'state' => 'Qatar'],
    'al-rayyan' => ['name' => 'Al Rayyan', 'state' => 'Qatar'],
    'lusail' => ['name' => 'Lusail', 'state' => 'Qatar'],
    'al-wakrah' => ['name' => 'Al Wakrah', 'state' => 'Qatar'],
    'al-wukair' => ['name' => 'Al Wukair', 'state' => 'Qatar'],
    'al-khor' => ['name' => 'Al Khor', 'state' => 'Qatar'],
    'umm-salal' => ['name' => 'Umm Salal', 'state' => 'Qatar'],
    'mesaieed' => ['name' => 'Mesaieed', 'state' => 'Qatar'],
    'rawdat-al-jahhaniya' => ['name' => 'Rawdat Al Jahhaniya', 'state' => 'Qatar'],
    'madinat-ash-shamal' => ['name' => 'Madinat ash Shamal', 'state' => 'Qatar'],
    'al-khawr' => ['name' => 'Al Khawr', 'state' => 'Qatar'],
    'old-al-rayyan' => ['name' => 'Old Al Rayyan', 'state' => 'Qatar'],
    'fereej-al-asmakh' => ['name' => 'Fereej Al Asmakh', 'state' => 'Qatar'],
    'ad-dawhah' => ['name' => 'Ad Dawhah', 'state' => 'Qatar'],
    'al-daayen' => ['name' => 'Al Daayen', 'state' => 'Qatar'],
    'al-shamal' => ['name' => 'Al Shamal', 'state' => 'Qatar'],
    'al-khawr-wa-adh-dhakhirah' => ['name' => 'Al Khawr wa adh Dhakhirah', 'state' => 'Qatar'],
    
    // Middle East Cities - UAE
    'abu-dhabi' => ['name' => 'Abu Dhabi', 'state' => 'UAE'],
    'khalifa-city' => ['name' => 'Khalifa City', 'state' => 'UAE'],
    'al-maryah-island' => ['name' => 'Al Maryah Island', 'state' => 'UAE'],
    'saadiyat-island' => ['name' => 'Saadiyat Island', 'state' => 'UAE'],
    'yas-island' => ['name' => 'Yas Island', 'state' => 'UAE'],
    'al-ain' => ['name' => 'Al Ain', 'state' => 'UAE'],
    'madinat-zayed' => ['name' => 'Madinat Zayed', 'state' => 'UAE'],
    'abu-dhabi-corniche' => ['name' => 'Abu Dhabi Corniche', 'state' => 'UAE'],
    'dubai' => ['name' => 'Dubai', 'state' => 'UAE'],
    'downtown-dubai' => ['name' => 'Downtown Dubai', 'state' => 'UAE'],
    'dubai-marina' => ['name' => 'Dubai Marina', 'state' => 'UAE'],
    'jumeirah' => ['name' => 'Jumeirah', 'state' => 'UAE'],
    'jbr' => ['name' => 'JBR', 'state' => 'UAE'],
    'jlt' => ['name' => 'JLT', 'state' => 'UAE'],
    'business-bay' => ['name' => 'Business Bay', 'state' => 'UAE'],
    'deira' => ['name' => 'Deira', 'state' => 'UAE'],
    'bur-dubai' => ['name' => 'Bur Dubai', 'state' => 'UAE'],
    'al-barsha' => ['name' => 'Al Barsha', 'state' => 'UAE'],
    'al-quoz' => ['name' => 'Al Quoz', 'state' => 'UAE'],
    'al-rigga' => ['name' => 'Al Rigga', 'state' => 'UAE'],
    'dubai-creek' => ['name' => 'Dubai Creek', 'state' => 'UAE'],
    'dubai-silicon-oasis' => ['name' => 'Dubai Silicon Oasis', 'state' => 'UAE'],
    'dubai-hills' => ['name' => 'Dubai Hills', 'state' => 'UAE'],
    'mirdif' => ['name' => 'Mirdif', 'state' => 'UAE'],
    'the-greens' => ['name' => 'The Greens', 'state' => 'UAE'],
    'sharjah' => ['name' => 'Sharjah', 'state' => 'UAE'],
    'al-majaz' => ['name' => 'Al Majaz', 'state' => 'UAE'],
    'khor-fakkan' => ['name' => 'Khor Fakkan', 'state' => 'UAE'],
    'kalba' => ['name' => 'Kalba', 'state' => 'UAE'],
    'ajman' => ['name' => 'Ajman', 'state' => 'UAE'],
    'masfout' => ['name' => 'Masfout', 'state' => 'UAE'],
    'umm-al-quwain' => ['name' => 'Umm Al Quwain', 'state' => 'UAE'],
    'ras-al-khaimah' => ['name' => 'Ras Al Khaimah', 'state' => 'UAE'],
    'al-hamra' => ['name' => 'Al Hamra', 'state' => 'UAE'],
    'fujairah' => ['name' => 'Fujairah', 'state' => 'UAE'],
    'dibba-al-fujairah' => ['name' => 'Dibba Al-Fujairah', 'state' => 'UAE'],
    
    // Middle East Cities - Kuwait
    'kuwait-city' => ['name' => 'Kuwait City', 'state' => 'Kuwait'],
    'sharq' => ['name' => 'Sharq', 'state' => 'Kuwait'],
    'salmiya' => ['name' => 'Salmiya', 'state' => 'Kuwait'],
    'jabriya' => ['name' => 'Jabriya', 'state' => 'Kuwait'],
    'hawalli' => ['name' => 'Hawalli', 'state' => 'Kuwait'],
    'mangaf' => ['name' => 'Mangaf', 'state' => 'Kuwait'],
    'fahaheel' => ['name' => 'Fahaheel', 'state' => 'Kuwait'],
    'al-farwaniyah' => ['name' => 'Al Farwaniyah', 'state' => 'Kuwait'],
    'egaila' => ['name' => 'Egaila', 'state' => 'Kuwait'],
    'jahra' => ['name' => 'Jahra', 'state' => 'Kuwait'],
    'sulaibikhat' => ['name' => 'Sulaibikhat', 'state' => 'Kuwait'],
    'bayan' => ['name' => 'Bayan', 'state' => 'Kuwait'],
    'fintas' => ['name' => 'Fintas', 'state' => 'Kuwait'],
    'khaitan' => ['name' => 'Khaitan', 'state' => 'Kuwait'],
    'andalus' => ['name' => 'Andalus', 'state' => 'Kuwait'],
    'al-asimah' => ['name' => 'Al Asimah', 'state' => 'Kuwait'],
    'al-ahmadi' => ['name' => 'Al Ahmadi', 'state' => 'Kuwait'],
    'al-jahra' => ['name' => 'Al Jahra', 'state' => 'Kuwait'],
    
    // Middle East Cities - Bahrain
    'manama' => ['name' => 'Manama', 'state' => 'Bahrain'],
    'juffair' => ['name' => 'Juffair', 'state' => 'Bahrain'],
    'muharraq' => ['name' => 'Muharraq', 'state' => 'Bahrain'],
    'riffa' => ['name' => 'Riffa', 'state' => 'Bahrain'],
    'isa-town' => ['name' => 'Isa Town', 'state' => 'Bahrain'],
    'sitra' => ['name' => 'Sitra', 'state' => 'Bahrain'],
    'busaiteen' => ['name' => 'Busaiteen', 'state' => 'Bahrain'],
    'budaiya' => ['name' => 'Budaiya', 'state' => 'Bahrain'],
    'hamala' => ['name' => 'Hamala', 'state' => 'Bahrain'],
    'jidhafs' => ['name' => 'Jidhafs', 'state' => 'Bahrain'],
    'capital' => ['name' => 'Capital', 'state' => 'Bahrain'],
    'southern-governorate' => ['name' => 'Southern Governorate', 'state' => 'Bahrain'],
    'central-governorate' => ['name' => 'Central Governorate', 'state' => 'Bahrain'],
    'northern-governorate' => ['name' => 'Northern Governorate', 'state' => 'Bahrain'],
    
    // Middle East Cities - Oman
    'muscat' => ['name' => 'Muscat', 'state' => 'Oman'],
    'ruwi' => ['name' => 'Ruwi', 'state' => 'Oman'],
    'muttrah' => ['name' => 'Muttrah', 'state' => 'Oman'],
    'seeb' => ['name' => 'Seeb', 'state' => 'Oman'],
    'qurum' => ['name' => 'Qurum', 'state' => 'Oman'],
    'al-khuwair' => ['name' => 'Al Khuwair', 'state' => 'Oman'],
    'nizwa' => ['name' => 'Nizwa', 'state' => 'Oman'],
    'sohar' => ['name' => 'Sohar', 'state' => 'Oman'],
    'salalah' => ['name' => 'Salalah', 'state' => 'Oman'],
    'buraimi' => ['name' => 'Buraimi', 'state' => 'Oman'],
    'sur' => ['name' => 'Sur', 'state' => 'Oman'],
    'ibri' => ['name' => 'Ibri', 'state' => 'Oman'],
    'muscat-governorate' => ['name' => 'Muscat Governorate', 'state' => 'Oman'],
    'ad-dakhiliyah' => ['name' => 'Ad Dakhiliyah', 'state' => 'Oman'],
    'al-batinah-north' => ['name' => 'Al Batinah North', 'state' => 'Oman'],
    'dhofar' => ['name' => 'Dhofar', 'state' => 'Oman'],
    'al-buraimi' => ['name' => 'Al Buraimi', 'state' => 'Oman'],
    'ash-sharqiyah-south' => ['name' => 'Ash Sharqiyah South', 'state' => 'Oman'],
    'ad-dhahirah' => ['name' => 'Ad Dhahirah', 'state' => 'Oman'],
    
    // Middle East Cities - Saudi Arabia
    'riyadh' => ['name' => 'Riyadh', 'state' => 'Saudi Arabia'],
    'olaya' => ['name' => 'Olaya', 'state' => 'Saudi Arabia'],
    'al-malaz' => ['name' => 'Al Malaz', 'state' => 'Saudi Arabia'],
    'al-nakheel' => ['name' => 'Al Nakheel', 'state' => 'Saudi Arabia'],
    'diriyah' => ['name' => 'Diriyah', 'state' => 'Saudi Arabia'],
    'jeddah' => ['name' => 'Jeddah', 'state' => 'Saudi Arabia'],
    'al-balad' => ['name' => 'Al Balad', 'state' => 'Saudi Arabia'],
    'corniche' => ['name' => 'Corniche', 'state' => 'Saudi Arabia'],
    'mecca' => ['name' => 'Mecca (Makkah)', 'state' => 'Saudi Arabia'],
    'mina' => ['name' => 'Mina', 'state' => 'Saudi Arabia'],
    'medina' => ['name' => 'Medina (Madinah)', 'state' => 'Saudi Arabia'],
    'dammam' => ['name' => 'Dammam', 'state' => 'Saudi Arabia'],
    'al-khobar' => ['name' => 'Al Khobar', 'state' => 'Saudi Arabia'],
    'dhahran' => ['name' => 'Dhahran', 'state' => 'Saudi Arabia'],
    'taif' => ['name' => 'Taif', 'state' => 'Saudi Arabia'],
    'abha' => ['name' => 'Abha', 'state' => 'Saudi Arabia'],
    'hofuf' => ['name' => 'Hofuf (Al Ahsa)', 'state' => 'Saudi Arabia'],
    'tabuk' => ['name' => 'Tabuk', 'state' => 'Saudi Arabia'],
    'hail' => ['name' => 'Hail', 'state' => 'Saudi Arabia'],
    'buraidah' => ['name' => 'Buraidah', 'state' => 'Saudi Arabia'],
    'khamis-mushait' => ['name' => 'Khamis Mushait', 'state' => 'Saudi Arabia'],
    'makkah-province' => ['name' => 'Makkah Province', 'state' => 'Saudi Arabia'],
    'al-madinah' => ['name' => 'Al Madinah', 'state' => 'Saudi Arabia'],
    'eastern-province' => ['name' => 'Eastern Province', 'state' => 'Saudi Arabia'],
    'aseer' => ['name' => 'Aseer', 'state' => 'Saudi Arabia'],
    'al-qassim' => ['name' => 'Al Qassim', 'state' => 'Saudi Arabia'],
    
    // Middle East Cities - Jordan
    'amman' => ['name' => 'Amman', 'state' => 'Jordan'],
    'abdoun' => ['name' => 'Abdoun', 'state' => 'Jordan'],
    'jabal-amman' => ['name' => 'Jabal Amman', 'state' => 'Jordan'],
    'zarqa' => ['name' => 'Zarqa', 'state' => 'Jordan'],
    'irbid' => ['name' => 'Irbid', 'state' => 'Jordan'],
    'aqaba' => ['name' => 'Aqaba', 'state' => 'Jordan'],
    'madaba' => ['name' => 'Madaba', 'state' => 'Jordan'],
    'salt' => ['name' => 'Salt (As-Salt)', 'state' => 'Jordan'],
    'jerash' => ['name' => 'Jerash', 'state' => 'Jordan'],
    'mafraq' => ['name' => 'Mafraq', 'state' => 'Jordan'],
    'amman-governorate' => ['name' => 'Amman Governorate', 'state' => 'Jordan'],
    'zarqa-governorate' => ['name' => 'Zarqa Governorate', 'state' => 'Jordan'],
    'irbid-governorate' => ['name' => 'Irbid Governorate', 'state' => 'Jordan'],
    'aqaba-governorate' => ['name' => 'Aqaba Governorate', 'state' => 'Jordan'],
    ...
    // Additional Global Cities - Asia
    'seoul' => ['name' => 'Seoul', 'state' => 'South Korea'],
    'busan' => ['name' => 'Busan', 'state' => 'South Korea'],
    'incheon' => ['name' => 'Incheon', 'state' => 'South Korea'],
    'daegu' => ['name' => 'Daegu', 'state' => 'South Korea'],
    'ulsan' => ['name' => 'Ulsan', 'state' => 'South Korea'],
    'gwangju' => ['name' => 'Gwangju', 'state' => 'South Korea'],
    'daejeon' => ['name' => 'Daejeon', 'state' => 'South Korea'],
    'goyang' => ['name' => 'Goyang', 'state' => 'South Korea'],
    'suwon' => ['name' => 'Suwon', 'state' => 'South Korea'],
    'beijing' => ['name' => 'Beijing', 'state' => 'China'],
    'shanghai' => ['name' => 'Shanghai', 'state' => 'China'],
    'shenzhen' => ['name' => 'Shenzhen', 'state' => 'China'],
    'guangzhou' => ['name' => 'Guangzhou', 'state' => 'China'],
    'chengdu' => ['name' => 'Chengdu', 'state' => 'China'],
    'chongqing' => ['name' => 'Chongqing', 'state' => 'China'],
    'tokyo' => ['name' => 'Tokyo', 'state' => 'Japan'],
    'osaka' => ['name' => 'Osaka', 'state' => 'Japan'],
    'kyoto' => ['name' => 'Kyoto', 'state' => 'Japan'],
    'kobe' => ['name' => 'Kobe', 'state' => 'Japan'],
    'yokohama' => ['name' => 'Yokohama', 'state' => 'Japan'],
    'nagoya' => ['name' => 'Nagoya', 'state' => 'Japan'],
    'sapporo' => ['name' => 'Sapporo', 'state' => 'Japan'],
    'bangkok' => ['name' => 'Bangkok', 'state' => 'Thailand'],
    'phuket' => ['name' => 'Phuket', 'state' => 'Thailand'],
    'chiang-mai' => ['name' => 'Chiang Mai', 'state' => 'Thailand'],
    'pattaya' => ['name' => 'Pattaya', 'state' => 'Thailand'],
    'nakhon-ratchasima' => ['name' => 'Nakhon Ratchasima', 'state' => 'Thailand'],
    'samut-prakan' => ['name' => 'Samut Prakan', 'state' => 'Thailand'],
    'pak-kret' => ['name' => 'Pak Kret', 'state' => 'Thailand'],
    'ho-chi-minh-city' => ['name' => 'Ho Chi Minh City', 'state' => 'Vietnam'],
    'hanoi' => ['name' => 'Hanoi', 'state' => 'Vietnam'],
    'hai-phong' => ['name' => 'Hai Phong', 'state' => 'Vietnam'],
    'da-nang' => ['name' => 'Da Nang', 'state' => 'Vietnam'],
    'can-tho' => ['name' => 'Can Tho', 'state' => 'Vietnam'],
    'nha-trang' => ['name' => 'Nha Trang', 'state' => 'Vietnam'],
    'si-racha' => ['name' => 'Si Racha', 'state' => 'Thailand'],
    'jakarta' => ['name' => 'Jakarta', 'state' => 'Indonesia'],
    'surabaya' => ['name' => 'Surabaya', 'state' => 'Indonesia'],
    'bandung' => ['name' => 'Bandung', 'state' => 'Indonesia'],
    'medan' => ['name' => 'Medan', 'state' => 'Indonesia'],
    'semarang' => ['name' => 'Semarang', 'state' => 'Indonesia'],
    'makassar' => ['name' => 'Makassar', 'state' => 'Indonesia'],
    'palembang' => ['name' => 'Palembang', 'state' => 'Indonesia'],
    'depok' => ['name' => 'Depok', 'state' => 'Indonesia'],
    'tangerang' => ['name' => 'Tangerang', 'state' => 'Indonesia'],
    'bekasi' => ['name' => 'Bekasi', 'state' => 'Indonesia'],
    'manila' => ['name' => 'Manila', 'state' => 'Philippines'],
    'quezon-city' => ['name' => 'Quezon City', 'state' => 'Philippines'],
    'caloocan' => ['name' => 'Caloocan', 'state' => 'Philippines'],
    'davao' => ['name' => 'Davao', 'state' => 'Philippines'],
    'zamboanga-city' => ['name' => 'Zamboanga City', 'state' => 'Philippines'],
    'cebu' => ['name' => 'Cebu', 'state' => 'Philippines'],
    'taguig' => ['name' => 'Taguig', 'state' => 'Philippines'],
    'george-town' => ['name' => 'George Town', 'state' => 'Malaysia'],
    'kuala-lumpur' => ['name' => 'Kuala Lumpur', 'state' => 'Malaysia'],
    'petaling-jaya' => ['name' => 'Petaling Jaya', 'state' => 'Malaysia'],
    'klang' => ['name' => 'Klang', 'state' => 'Malaysia'],
    'kota-kinabalu' => ['name' => 'Kota Kinabalu', 'state' => 'Malaysia'],
    'kuching' => ['name' => 'Kuching', 'state' => 'Malaysia'],
    'johor-bahru' => ['name' => 'Johor Bahru', 'state' => 'Malaysia'],
    'ipoh' => ['name' => 'Ipoh', 'state' => 'Malaysia'],
    'kuala-terengganu' => ['name' => 'Kuala Terengganu', 'state' => 'Malaysia'],
    
    // Additional Global Cities - Europe
    'london' => ['name' => 'London', 'state' => 'United Kingdom'],
    'manchester' => ['name' => 'Manchester', 'state' => 'United Kingdom'],
    'birmingham' => ['name' => 'Birmingham', 'state' => 'United Kingdom'],
    'leeds' => ['name' => 'Leeds', 'state' => 'United Kingdom'],
    'liverpool' => ['name' => 'Liverpool', 'state' => 'United Kingdom'],
    'bristol' => ['name' => 'Bristol', 'state' => 'United Kingdom'],
    'edinburgh' => ['name' => 'Edinburgh', 'state' => 'Scotland'],
    'glasgow' => ['name' => 'Glasgow', 'state' => 'Scotland'],
    'cardiff' => ['name' => 'Cardiff', 'state' => 'Wales'],
    'belfast' => ['name' => 'Belfast', 'state' => 'Northern Ireland'],
    'paris' => ['name' => 'Paris', 'state' => 'France'],
    'lyon' => ['name' => 'Lyon', 'state' => 'France'],
    'marseille' => ['name' => 'Marseille', 'state' => 'France'],
    'toulouse' => ['name' => 'Toulouse', 'state' => 'France'],
    'nice' => ['name' => 'Nice', 'state' => 'France'],
    'montpellier' => ['name' => 'Montpellier', 'state' => 'France'],
    'strasbourg' => ['name' => 'Strasbourg', 'state' => 'France'],
    'bordeaux' => ['name' => 'Bordeaux', 'state' => 'France'],
    'berlin' => ['name' => 'Berlin', 'state' => 'Germany'],
    'munich' => ['name' => 'Munich', 'state' => 'Germany'],
    'hamburg' => ['name' => 'Hamburg', 'state' => 'Germany'],
    'cologne' => ['name' => 'Cologne', 'state' => 'Germany'],
    'frankfurt' => ['name' => 'Frankfurt', 'state' => 'Germany'],
    'dusseldorf' => ['name' => 'Düsseldorf', 'state' => 'Germany'],
    'dortmund' => ['name' => 'Dortmund', 'state' => 'Germany'],
    'essen' => ['name' => 'Essen', 'state' => 'Germany'],
    'madrid' => ['name' => 'Madrid', 'state' => 'Spain'],
    'barcelona' => ['name' => 'Barcelona', 'state' => 'Spain'],
    'valencia' => ['name' => 'Valencia', 'state' => 'Spain'],
    'seville' => ['name' => 'Seville', 'state' => 'Spain'],
    'bilbao' => ['name' => 'Bilbao', 'state' => 'Spain'],
    'malaga' => ['name' => 'Malaga', 'state' => 'Spain'],
    'amsterdam' => ['name' => 'Amsterdam', 'state' => 'Netherlands'],
    'rotterdam' => ['name' => 'Rotterdam', 'state' => 'Netherlands'],
    'the-hague' => ['name' => 'The Hague', 'state' => 'Netherlands'],
    'utrecht' => ['name' => 'Utrecht', 'state' => 'Netherlands'],
    'brussels' => ['name' => 'Brussels', 'state' => 'Belgium'],
    'antwerp' => ['name' => 'Antwerp', 'state' => 'Belgium'],
    'zurich' => ['name' => 'Zurich', 'state' => 'Switzerland'],
    'bern' => ['name' => 'Bern', 'state' => 'Switzerland'],
    'geneva' => ['name' => 'Geneva', 'state' => 'Switzerland'],
    'basel' => ['name' => 'Basel', 'state' => 'Switzerland'],
    'biel' => ['name' => 'Biel', 'state' => 'Switzerland'],
    'lucerne' => ['name' => 'Lucerne', 'state' => 'Switzerland'],
    'st-gallen' => ['name' => 'St. Gallen', 'state' => 'Switzerland'],
    'winterthur' => ['name' => 'Winterthur', 'state' => 'Switzerland'],
    'lugano' => ['name' => 'Lugano', 'state' => 'Switzerland'],
    'vienna' => ['name' => 'Vienna', 'state' => 'Austria'],
    'prague' => ['name' => 'Prague', 'state' => 'Czech Republic'],
    'warsaw' => ['name' => 'Warsaw', 'state' => 'Poland'],
    'krakow' => ['name' => 'Krakow', 'state' => 'Poland'],
    'wroclaw' => ['name' => 'Wroclaw', 'state' => 'Poland'],
    'poznan' => ['name' => 'Poznan', 'state' => 'Poland'],
    'budapest' => ['name' => 'Budapest', 'state' => 'Hungary'],
    'bucharest' => ['name' => 'Bucharest', 'state' => 'Romania'],
    'sofia' => ['name' => 'Sofia', 'state' => 'Bulgaria'],
    'athens' => ['name' => 'Athens', 'state' => 'Greece'],
    'thessaloniki' => ['name' => 'Thessaloniki', 'state' => 'Greece'],
    'lisbon' => ['name' => 'Lisbon', 'state' => 'Portugal'],
    'porto' => ['name' => 'Porto', 'state' => 'Portugal'],
    'moscow' => ['name' => 'Moscow', 'state' => 'Russia'],
    'st-petersburg' => ['name' => 'St. Petersburg', 'state' => 'Russia'],
    'saint-petersburg' => ['name' => 'Saint Petersburg', 'state' => 'Russia'],
    'samara' => ['name' => 'Samara', 'state' => 'Russia'],
    'omsk' => ['name' => 'Omsk', 'state' => 'Russia'],
    'genoa' => ['name' => 'Genoa', 'state' => 'Italy'],
    'turin' => ['name' => 'Turin', 'state' => 'Italy'],
    'cordoba' => ['name' => 'Cordoba', 'state' => 'Spain'],
    'mersin' => ['name' => 'Mersin', 'state' => 'Turkey'],
    'bursa' => ['name' => 'Bursa', 'state' => 'Turkey'],
    'istanbul' => ['name' => 'Istanbul', 'state' => 'Turkey'],
    'ankara' => ['name' => 'Ankara', 'state' => 'Turkey'],
    'izmir' => ['name' => 'Izmir', 'state' => 'Turkey'],
    'konya' => ['name' => 'Konya', 'state' => 'Turkey'],
    'diyarbakir' => ['name' => 'Diyarbakir', 'state' => 'Turkey'],
    'adana' => ['name' => 'Adana', 'state' => 'Turkey'],
    'linkoping' => ['name' => 'Linköping', 'state' => 'Sweden'],
    'jonkoping' => ['name' => 'Jönköping', 'state' => 'Sweden'],
    'uppsala' => ['name' => 'Uppsala', 'state' => 'Sweden'],
    
    // Additional Global Cities - North America
    'new-york' => ['name' => 'New York', 'state' => 'USA'],
    'los-angeles' => ['name' => 'Los Angeles', 'state' => 'USA'],
    'chicago' => ['name' => 'Chicago', 'state' => 'USA'],
    'houston' => ['name' => 'Houston', 'state' => 'USA'],
    'phoenix' => ['name' => 'Phoenix', 'state' => 'USA'],
    'philadelphia' => ['name' => 'Philadelphia', 'state' => 'USA'],
    'san-antonio' => ['name' => 'San Antonio', 'state' => 'USA'],
    'san-diego' => ['name' => 'San Diego', 'state' => 'USA'],
    'dallas' => ['name' => 'Dallas', 'state' => 'USA'],
    'san-jose' => ['name' => 'San Jose', 'state' => 'USA'],
    'austin' => ['name' => 'Austin', 'state' => 'USA'],
    'jacksonville' => ['name' => 'Jacksonville', 'state' => 'USA'],
    ...
    'atlanta' => ['name' => 'Atlanta', 'state' => 'USA'],
    'detroit' => ['name' => 'Detroit', 'state' => 'USA'],
    'minneapolis' => ['name' => 'Minneapolis', 'state' => 'USA'],
    'saint-paul' => ['name' => 'Saint Paul', 'state' => 'USA'],
    'el-paso' => ['name' => 'El Paso', 'state' => 'USA'],
    'nashville' => ['name' => 'Nashville', 'state' => 'USA'],
    'memphis' => ['name' => 'Memphis', 'state' => 'USA'],
    'louisville' => ['name' => 'Louisville', 'state' => 'USA'],
    'baltimore' => ['name' => 'Baltimore', 'state' => 'USA'],
    'charlotte' => ['name' => 'Charlotte', 'state' => 'USA'],
    'st-louis' => ['name' => 'St. Louis', 'state' => 'USA'],
    'stockton' => ['name' => 'Stockton', 'state' => 'USA'],
    'madison' => ['name' => 'Madison', 'state' => 'USA'],
    'plano' => ['name' => 'Plano', 'state' => 'USA'],
    'arlington' => ['name' => 'Arlington', 'state' => 'USA'],
    'new-orleans' => ['name' => 'New Orleans', 'state' => 'USA'],
    'durham' => ['name' => 'Durham', 'state' => 'USA'],
    'oklahoma-city' => ['name' => 'Oklahoma City', 'state' => 'USA'],
    'lubbock' => ['name' => 'Lubbock', 'state' => 'USA'],
    'cleveland' => ['name' => 'Cleveland', 'state' => 'USA'],
    'wichita' => ['name' => 'Wichita', 'state' => 'USA'],
    'hialeah' => ['name' => 'Hialeah', 'state' => 'USA'],
    'fresno' => ['name' => 'Fresno', 'state' => 'USA'],
    'sacramento' => ['name' => 'Sacramento', 'state' => 'USA'],
    'long-beach' => ['name' => 'Long Beach', 'state' => 'USA'],
    'kansas-city' => ['name' => 'Kansas City', 'state' => 'USA'],
    'albuquerque' => ['name' => 'Albuquerque', 'state' => 'USA'],
    'spokane' => ['name' => 'Spokane', 'state' => 'USA'],
    'glendale' => ['name' => 'Glendale', 'state' => 'USA'],
    'garland' => ['name' => 'Garland', 'state' => 'USA'],
    'montgomery' => ['name' => 'Montgomery', 'state' => 'USA'],
    'riverside' => ['name' => 'Riverside', 'state' => 'USA'],
    'bakersfield' => ['name' => 'Bakersfield', 'state' => 'USA'],
    'chandler' => ['name' => 'Chandler', 'state' => 'USA'],
    'chula-vista' => ['name' => 'Chula Vista', 'state' => 'USA'],
    'greensboro' => ['name' => 'Greensboro', 'state' => 'USA'],
    'chesapeake' => ['name' => 'Chesapeake', 'state' => 'USA'],
    'raleigh' => ['name' => 'Raleigh', 'state' => 'USA'],
    'laredo' => ['name' => 'Laredo', 'state' => 'USA'],
    'richmond' => ['name' => 'Richmond', 'state' => 'USA'],
    'irving' => ['name' => 'Irving', 'state' => 'USA'],
    'scottsdale' => ['name' => 'Scottsdale', 'state' => 'USA'],
    'fremont' => ['name' => 'Fremont', 'state' => 'USA'],
    'henderson' => ['name' => 'Henderson', 'state' => 'USA'],
    'honolulu' => ['name' => 'Honolulu', 'state' => 'USA'],
    'anchorage' => ['name' => 'Anchorage', 'state' => 'USA'],
    'lincoln' => ['name' => 'Lincoln', 'state' => 'USA'],
    'virginia-beach' => ['name' => 'Virginia Beach', 'state' => 'USA'],
    'toronto' => ['name' => 'Toronto', 'state' => 'Canada'],
    'vancouver' => ['name' => 'Vancouver', 'state' => 'Canada'],
    'edmonton' => ['name' => 'Edmonton', 'state' => 'Canada'],
    'winnipeg' => ['name' => 'Winnipeg', 'state' => 'Canada'],
    'ottawa' => ['name' => 'Ottawa', 'state' => 'Canada'],
    'montreal' => ['name' => 'Montreal', 'state' => 'Canada'],
    'calgary' => ['name' => 'Calgary', 'state' => 'Canada'],
    'quebec-city' => ['name' => 'Quebec City', 'state' => 'Canada'],
    'hamilton' => ['name' => 'Hamilton', 'state' => 'Canada'],
    'mexico-city' => ['name' => 'Mexico City', 'state' => 'Mexico'],
    'guadalajara' => ['name' => 'Guadalajara', 'state' => 'Mexico'],
    'monterrey' => ['name' => 'Monterrey', 'state' => 'Mexico'],
    'puebla' => ['name' => 'Puebla', 'state' => 'Mexico'],
    'leon' => ['name' => 'Leon', 'state' => 'Mexico'],
    'cancun' => ['name' => 'Cancun', 'state' => 'Mexico'],
    'merida' => ['name' => 'Merida', 'state' => 'Mexico'],
    'torreon' => ['name' => 'Torreon', 'state' => 'Mexico'],
    'queretaro' => ['name' => 'Queretaro', 'state' => 'Mexico'],
    'rosario' => ['name' => 'Rosario', 'state' => 'Argentina'],
    
    // Additional Global Cities - South America
    ...
    'salvador' => ['name' => 'Salvador', 'state' => 'Brazil'],
    'fortaleza' => ['name' => 'Fortaleza', 'state' => 'Brazil'],
    'porto-alegre' => ['name' => 'Porto Alegre', 'state' => 'Brazil'],
    'manaus' => ['name' => 'Manaus', 'state' => 'Brazil'],
    'recife' => ['name' => 'Recife', 'state' => 'Brazil'],
    'curitiba' => ['name' => 'Curitiba', 'state' => 'Brazil'],
    'brasilia' => ['name' => 'Brasilia', 'state' => 'Brazil'],
    'belo-horizonte' => ['name' => 'Belo Horizonte', 'state' => 'Brazil'],
    'mendoza' => ['name' => 'Mendoza', 'state' => 'Argentina'],
    'la-plata' => ['name' => 'La Plata', 'state' => 'Argentina'],
    'tucuman' => ['name' => 'Tucuman', 'state' => 'Argentina'],
    'lima' => ['name' => 'Lima', 'state' => 'Peru'],
    'cusco' => ['name' => 'Cusco', 'state' => 'Peru'],
    'bogota' => ['name' => 'Bogota', 'state' => 'Colombia'],
    'medellin' => ['name' => 'Medellin', 'state' => 'Colombia'],
    'cali' => ['name' => 'Cali', 'state' => 'Colombia'],
    'caracas' => ['name' => 'Caracas', 'state' => 'Venezuela'],
    'santiago' => ['name' => 'Santiago', 'state' => 'Chile'],
    'guayaquil' => ['name' => 'Guayaquil', 'state' => 'Ecuador'],
    'quito' => ['name' => 'Quito', 'state' => 'Ecuador'],
    'la-paz' => ['name' => 'La Paz', 'state' => 'Bolivia'],
    
    // Additional Global Cities - Africa
    'johannesburg' => ['name' => 'Johannesburg', 'state' => 'South Africa'],
    'cape-town' => ['name' => 'Cape Town', 'state' => 'South Africa'],
    'durban' => ['name' => 'Durban', 'state' => 'South Africa'],
    'pietermaritzburg' => ['name' => 'Pietermaritzburg', 'state' => 'South Africa'],
    'cairo' => ['name' => 'Cairo', 'state' => 'Egypt'],
    'alexandria' => ['name' => 'Alexandria', 'state' => 'Egypt'],
    'lagos' => ['name' => 'Lagos', 'state' => 'Nigeria'],
    'abuja' => ['name' => 'Abuja', 'state' => 'Nigeria'],
    'accra' => ['name' => 'Accra', 'state' => 'Ghana'],
    'nairobi' => ['name' => 'Nairobi', 'state' => 'Kenya'],
    'kampala' => ['name' => 'Kampala', 'state' => 'Uganda'],
    'addis-ababa' => ['name' => 'Addis Ababa', 'state' => 'Ethiopia'],
    'khartoum' => ['name' => 'Khartoum', 'state' => 'Sudan'],
    'dakar' => ['name' => 'Dakar', 'state' => 'Senegal'],
    'tunis' => ['name' => 'Tunis', 'state' => 'Tunisia'],
    'algiers' => ['name' => 'Algiers', 'state' => 'Algeria'],
    'marrakech' => ['name' => 'Marrakech', 'state' => 'Morocco'],
    'casablanca' => ['name' => 'Casablanca', 'state' => 'Morocco'],
    'kinshasa' => ['name' => 'Kinshasa', 'state' => 'DR Congo'],
    'harare' => ['name' => 'Harare', 'state' => 'Zimbabwe'],
    'lusaka' => ['name' => 'Lusaka', 'state' => 'Zambia'],
    'dar-es-salaam' => ['name' => 'Dar es Salaam', 'state' => 'Tanzania'],
    'lilongwe' => ['name' => 'Lilongwe', 'state' => 'Malawi'],
    'maputo' => ['name' => 'Maputo', 'state' => 'Mozambique'],
    'gaborone' => ['name' => 'Gaborone', 'state' => 'Botswana'],
    'windhoek' => ['name' => 'Windhoek', 'state' => 'Namibia'],
    
    // Additional Asian Cities
    'taipei' => ['name' => 'Taipei', 'state' => 'Taiwan'],
    'kaohsiung' => ['name' => 'Kaohsiung', 'state' => 'Taiwan'],
    'taichung' => ['name' => 'Taichung', 'state' => 'Taiwan'],
    'taoyuan' => ['name' => 'Taoyuan', 'state' => 'Taiwan'],
    'changhua' => ['name' => 'Changhua', 'state' => 'Taiwan'],
    'hong-kong' => ['name' => 'Hong Kong', 'state' => 'Hong Kong'],
    'singapore' => ['name' => 'Singapore', 'state' => 'Singapore'],
    'kathmandu' => ['name' => 'Kathmandu', 'state' => 'Nepal'],
    'dhaka' => ['name' => 'Dhaka', 'state' => 'Bangladesh'],
    'chittagong' => ['name' => 'Chittagong', 'state' => 'Bangladesh'],
    'colombo' => ['name' => 'Colombo', 'state' => 'Sri Lanka'],
    'kandy' => ['name' => 'Kandy', 'state' => 'Sri Lanka'],
    'lahore' => ['name' => 'Lahore', 'state' => 'Pakistan'],
    'karachi' => ['name' => 'Karachi', 'state' => 'Pakistan'],
    'islamabad' => ['name' => 'Islamabad', 'state' => 'Pakistan'],
    'rawalpindi' => ['name' => 'Rawalpindi', 'state' => 'Pakistan'],
    'faisalabad' => ['name' => 'Faisalabad', 'state' => 'Pakistan'],
    'multan' => ['name' => 'Multan', 'state' => 'Pakistan'],
    'peshawar' => ['name' => 'Peshawar', 'state' => 'Pakistan'],
    'quetta' => ['name' => 'Quetta', 'state' => 'Pakistan'],
    'hue' => ['name' => 'Hue', 'state' => 'Vietnam']
];
