...
$page_title = "Professional Content Writing Services in {$fullCityName} | ThiyagiDigital";
...
<section id="bi-breadcrumbs" class="bi-bredcrumbs-section position-relative about-bgimgsize" data-background="/assets/img/bg/bread-bg.jpg">
    ...
    <div class="container">
        <div class="bi-breadcrumbs-content headline ul-li text-center">
            <h1 style="color: white"><b>Best Content Writing Services in <?php echo $fullCityName; ?></b></h1><br>
            <ul>
                <li><a href="/">Home</a></li>
                                        ...
                                        <div class="accordion" id="accordionSidebarCONTENT">
                                            <div class="accordion-item">
                                                ...
                                                <div id="cwfaq1c" class="accordion-collapse collapse" aria-labelledby="cwfaq1" data-bs-parent="#accordionSidebarCONTENT">
                                                    <div class="accordion-body">
                                                        Yesâ€”vernacular content available for audiences in <?php echo $fullCityName; ?>.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
