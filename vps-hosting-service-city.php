...
$page_keywords = 'VPS hosting {city}, virtual private server {city}, dedicated server hosting {city}, cloud VPS {city}';
...
if (!array_key_exists($citySlug, $supportedCities)) {
    header("Location: /vps-hosting-service/");
    exit();
}
		...
		<div class="container">
			...
			<div class="cities-grid">
				...
				foreach($major_cities as $major_city): ?>
					<a href="/vps-hosting-service/<?php echo strtolower(str_replace(' ', '-', $major_city)); ?>" 
